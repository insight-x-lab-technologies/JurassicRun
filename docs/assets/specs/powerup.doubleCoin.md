# Asset Spec — powerup.doubleCoin

## Identidade
- **id:** `powerup.doubleCoin`
- **Categoria:** power-up (efeito temporário — comida coletada vale em dobro)
...
- **Animação:** opcional brilho/rotação sutil (2–4 frames); 1 frame aceitável no placeholder.
...
- **Paleta:** corpo dourado `#ffe14a`, contorno `#7a5a12`, realce `#fff4bf`.
- **Iluminação/ângulo:** vista frontal, luz superior suave.
- **Coerência:** par de moedas sobrepostas (ecoando a silhueta de `bird.coin`, mas duplicada), legível num círculo pequeno.

## Prompt para geração por IA
> "2D game icon of two overlapping small golden coins, flat cartoon vector style, bold dark outline, simple cel shading, transparent background, centered, no text, no shadow."
